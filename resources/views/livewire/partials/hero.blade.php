    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
            <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                Start your journey with <span class="text-blue-600">Used Shop Cars</span></h1>
            <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">"Find a wide selection of quality pre-owned
                cars, from sedans to SUVs, at unbeatable prices!"</p>
