        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="/" aria-label="Brand">Used Shop Cars</a>
                <div class="md:hidden">
                    <button type="button"
                            ...
                            <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none]  md:py-4">
                                <button type="button"
                                    ...
                                    <div class="flex items-center space-x-4">
                                        @if (auth()->user()->avatar)
                                            <img src="http://usedcarshop.test/storage/{{auth()->user()->avatar}}" alt="avatar"
                                                class="hidden md:block w-10 h-10 rounded-full border border-gray-300 shadow-md" />
                                        @else
                                        ...
                                        <p
                                            class="block md:hidden font-medium text-gray-500 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                            {{ auth()->user()->name }}
                                        </p>
                                    </div>
                                </button>
                                <div
                                    class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full md:border before:-top-5 before:start-0 w-fit before:h-5 ">
