                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="zip_code" wire:model='zip_code' type="text">
                                </input>
                                @error('zip_code')
                                    <div class="text-red-500 text-sm">
                                        {{ $message }}
                            ...
                            <li class="py-3 sm:py-4" wire:key='{{ $ci['product_id'] }}'>
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="Neil image" class="w-12 h-12 object-cover"
                                            src="{{ $ci['image'] ? url('storage', $ci['image']) : asset('images/default-avatar.png') }}">
                                    </div>
